    ...
    <div className="max-w-[90%] mx-auto">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-16 mb-24 ">
        <div>
          ...
          <a href="https://matjournals.net/engineering/index.php/JoCNSDC/article/view/361" target="_blank" className=" group block p-8 bg-slate-50 rounded-3xl hover:bg-slate-100 transition-all border border-transparent hover:border-slate-200 ">
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-4">
            {[
              ...
              <div key={i} className="px-6 py-4 bg-slate-50 rounded-2xl border border-slate-100">
